...
import { CartActionButton } from '@/app/(fsd)/features/cart-action-button'
        ...
        <>
            ...
            <Container className='flex gap-x-12'>
                <div className='relative w-[400px] h-[400px]'>
                    <Image className='rounded-lg object-cover object-center' src={`${BASE_URL}/${data.imageUrl}`} fill alt={data?.name} />
                </div>
